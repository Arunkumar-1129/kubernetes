...
## 🎨 Enhanced Flask Landing Page

The application was upgraded from a simple text response:

```python
return "Hello from Arun Kumar Python Docker Application!"
```

to a modern responsive landing page featuring:

* Personal Profile Image
* Gradient Background
* Docker Deployment Status Badge
...
GitLab CI/CD automatically builds and pushes Docker images using the Git Commit SHA as the image tag.
...
docker_build_job:
  ...
  script:
    - docker build -t python-app:$CI_COMMIT_SHORT_SHA .
    - docker images
    - docker tag python-app:$CI_COMMIT_SHORT_SHA arunkumar1129/python-app:$CI_COMMIT_SHORT_SHA
    - docker login -u $DOCKER_USERNAME -p $DOCKER_PASSWORD
    - docker push arunkumar1129/python-app:$CI_COMMIT_SHORT_SHA
```

### GitLab Variables

```text
DOCKER_USERNAME = arunkumar1129
...
```bash
docker pull arunkumar1129/python-app:<image-tag>
```

Run Container:

```bash
docker run -d -p 8080:5000 arunkumar1129/python-app:6d762572
```
...
## 📌 Sample Image Tags Generated by GitLab

```text
arunkumar1129/python-app:a1b2c3
arunkumar1129/python-app:d4e5f6
arunkumar1129/python-app:6d762572
```

Each Git commit automatically creates a new Docker image version and pushes it to Docker Hub.


[![IMG-20260612-WA0014.jpg](https://i.postimg.cc/j2CN9rL8/IMG-20260612-WA0014.jpg)](https://postimg.cc/0KRbMFGm)
[![IMG-20260612-WA0015.jpg](https://i.postimg.cc/90zTSjrt/IMG-20260612-WA0015.jpg)](https://postimg.cc/Fk57d8b7)
